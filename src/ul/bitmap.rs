...
use crate::ul::ffi::{
    ULBitmap, ulBitmapErase, ulBitmapGetBpp, ulBitmapGetFormat, ulBitmapGetHeight,
    ulBitmapGetRowBytes, ulBitmapGetSize, ulBitmapGetWidth, ulBitmapIsEmpty, ulBitmapLockPixels,
    ulBitmapOwnsPixels, ulBitmapRawPixels, ulBitmapSwapRedBlueChannels, ulBitmapUnlockPixels,
    ulBitmapWritePNG, ulCreateBitmap, ulCreateBitmapFromCopy, ulCreateBitmapFromPixels,
    ulCreateEmptyBitmap, ulDestroyBitmap,
};
...
impl Bitmap {
    ...
    pub unsafe fn raw_pixels(&self) -> *mut u8 {
        unsafe { ulBitmapRawPixels(self.raw) as *mut u8 }
    }
