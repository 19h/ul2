use crate::ul::ffi::{ULImageSource, ULRect, ULBitmap, ulCreateImageSourceFromTexture, 
                ulCreateImageSourceFromBitmap, ulDestroyImageSource, ulImageSourceInvalidate,
                ulImageSourceProviderAddImageSource, ulImageSourceProviderRemoveImageSource};
...
impl ImageSource {
    ...
    pub fn from_texture(width: u32, height: u32, texture_id: u32, texture_uv: Rect, bitmap: Option<&Bitmap>) -> Self {
        unsafe {
