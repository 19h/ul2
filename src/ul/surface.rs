...
use crate::ul::ffi::{
    ...
    ulSurfaceGetSize, ulSurfaceGetUserData, ulSurfaceGetWidth, ulSurfaceLockPixels,
    ulSurfaceResize, ulSurfaceSetDirtyBounds, ulSurfaceUnlockPixels,
};
...
pub trait SurfaceDefinition {
    ...
    where
        Self: Sized,
    {
        extern "C" fn create_callback<T: SurfaceDefinition>(
            width: u32,
            height: u32,
        ) -> *mut c_void {
        ...
        extern "C" fn lock_pixels_callback<T: SurfaceDefinition>(
        ...
        extern "C" fn resize_callback<T: SurfaceDefinition>(
            user_data: *mut c_void,
            width: u32,
            height: u32,
        ) {
